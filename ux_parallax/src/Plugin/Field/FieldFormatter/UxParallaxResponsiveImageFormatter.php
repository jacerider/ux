 ...
 *
 * @FieldFormatter(
 *  id = "ux_parallax_responsive_image_formatter",
 *  label = @Translation("Responsive Parallax Image"),
 *  field_types = {"image"}
 * )
 */
class UxParallaxResponsiveImageFormatter extends ResponsiveImageFormatter {
